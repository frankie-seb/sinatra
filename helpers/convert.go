...
func IDToBoilerNullInt(id *string) null.Int {
	if id == nil {
		return null.Int{
			Int:   0,
			Valid: false,
	...
	return null.IntFrom(int(IDToBoiler(*id)))
}
...
func NullDotTimeToString(v null.Time) string {
	if !v.Valid {
		return ""
	}
	u := v.Time.String()
...
func NullDotTimeToPointerString(v null.Time) *string {
	if !v.Valid {
		return nil
	}
	u := v.Time.String()
...
func TimeDotTimeToPointerString(v time.Time) *string {
	u := v.String()
	return &u
}
...
func TimeDotTimeToString(v time.Time) string {
	return v.String()
}
...
func TypesJSONToInterface(v types.JSON) interface{} {
	return v
}

func TypesJSONToString(v types.JSON) string {
	return fmt.Sprintf("%v", v)
}

func InterfaceToTypesJSON(v interface{}) types.JSON {
...
func InterfaceToNullDotJSON(v interface{}) null.JSON {
	if v == nil {
		return null.NewJSON(nil, false)
	}
	b, err := json.Marshal(v)
	if err != nil {
		return null.NewJSON(nil, false)
	}
	return null.NewJSON(b, true)
}

func NullDotJSONToInterface(v null.JSON) interface{} {
	if !v.Valid {
		return ""
	}
...
func NullDotJSONToPointerString(v null.JSON) *string {
	// TODO check if valid
	b := fmt.Sprintf("%v", v.JSON)

	return &b
}

func JSONToString(v types.JSON) string {
	// TODO check if valid
	b := fmt.Sprintf("%v", v)
...
func PointerStringToNullDotJSON(v *string) null.JSON {
	if v == nil {
		return null.NewJSON(nil, false)
	}
	b, err := json.Marshal(v)
...
func StringToJSON(v string) types.JSON {
	b, err := json.Marshal(v)
	if err != nil {
...
func PointerStringToJSON(v *string) types.JSON {
	if v == nil {
		return types.JSON(nil)
	}
	b, err := json.Marshal(v)
...
func PointerStringToNullDotTime(v *string) null.Time {
	if v != nil {
		t, e := time.Parse("01/02/2006 3:04:05 PM", *v)
...
func PointerTimeToTime(v *time.Time) time.Time {
	return *v
}
...
func NullDotIntToPointerString(v null.Int) *string {
